...
namespace Hbx.WebGL
{
	...
	public class WebGLRetinaToolsDemo : MonoBehaviour
	{
		...
		void Update()
		{
			...
			// this gets called by a button, but could call it here
			//OnClickedScreen();
		}

		/// <summary>
		/// This code could just go in Update but we've hooked it up to a fullscreen invidible button
		/// so that we don't trigger ball drops when we touch the UI
		/// </summary>
